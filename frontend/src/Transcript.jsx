    ...
    <div className="pane" style={{ background: "var(--bg-base)" }}>
      ...
      <div className="transcript" ref={scrollerRef}>
        <div className="transcript-inner">
          {calling && turns.length === 0 && !partialText && (
            <div style={{ color: "var(--fg-tertiary)", fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase", padding: "16px 0" }}>
              Listening…
            </div>
          )}
          {turns.map((t, i) => (
