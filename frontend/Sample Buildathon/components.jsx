/* Shared primitives: PanelHeader, Toggle, MetricBlock, Sparkline, etc. */

const { useState, useEffect, useRef, useMemo, useCallback } = React;

/* -------- Panel header -------- */
function PanelHeader({ label, right, children }) {
  return (
...
function ProviderToggle({ label, value, options, onChange }) {
  // Use a native select for simplicity, styled to match the toggle look
  return (
...
/* -------- Metric block -------- */
function MetricBlock({ label, value, unit, frac, delta, vs, hero, spark, sparkColor, flash }) {
  return (
...
Object.assign(window, {
  PanelHeader, Toggle, ProviderToggle, Sparkline, MetricBlock, Section,
});
